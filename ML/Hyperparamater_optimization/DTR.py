...
models = {
    'decisiontreeregressor': (DecisionTreeRegressor(), {
        ...
        'decisiontreeregressor__max_depth': np.round(np.arange(3, 11, 1), 0).tolist(),
        'decisiontreeregressor__min_samples_split': [1, 2, 5, 10, 15, 20],
        'decisiontreeregressor__random_state': [876543],
    }),
