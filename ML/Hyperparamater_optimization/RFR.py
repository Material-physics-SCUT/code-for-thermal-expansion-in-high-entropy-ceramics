...
models = {
    ...
    'randomforestregressor': (RandomForestRegressor(), {
        ...
        'randomforestregressor__max_depth': np.round(np.arange(3, 11, 1), 0).tolist(),
        'randomforestregressor__min_samples_split': [1, 2, 5, 10, 15, 20],
        'randomforestregressor__random_state': [876543],
    })
}
